...
header:
featured_image: /articles/development/game-review-scores-part-iii/teaser.png
tags: []
...
All of the data used to build these visualizations was extracted from various web sites using a few [Python](https://www.python.org) scripts.  The [Beautiful Soup](https://www.crummy.com/software/BeautifulSoup) library was used to parse and traverse the HTML.
...
Scraping data from web pages is easy as long as you completely ignore the impulse to follow good coding practices.  Don't feel bad about going gangbusters with [Law of Demeter](https://en.wikipedia.org/wiki/Law_of_Demeter) violations - if the layout changes you'll probably have to rewrite it anyway.
...
[Tableau Desktop](https://www.tableausoftware.com) was used to explore the data and arrive at the most interesting details that were worth publishing. The workbook and data extracts were uploaded to [Tableau Public](https://www.tableausoftware.com/products/public) so they could be embedded into posts.
